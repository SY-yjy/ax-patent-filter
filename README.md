...
| `엑셀폴백:ONkey없음` | 원문키 컬럼 없음 (214~217회차) |
| `엑셀폴백:ONkey형식오류` | 원문키 값이 13자리가 아님 (221~224회차) |
...
- 스캔 판독: 231k~289k토큰 · 68~87초/건 → **캐시되어 특허당 1회만**
- 225~228회차 812행: ON key 전건 정상, 스캔 예상 73건 이상(PCT 68 + EP 5 실측)
